...
const protocol_headers_js_1 = require("../protocol/protocol-headers.js");
...
function setTrailerStatus(target, error) {
    if (error) {
        ...
        if (!error.isWireError) {
            (0, protocol_headers_js_1.mergeNonProtocolHeaders)(target, error.metadata);
        }
...
function findTrailerError(headerOrTrailer) {
    ...
    if (grpcStatus != null) {
        ...
        if (code in code_js_1.Code) {
            error = new connect_error_js_1.ConnectError(decodeURIComponent((_a = headerOrTrailer.get(headers_js_1.headerGrpcMessage)) !== null && _a !== void 0 ? _a : ""), code, headerOrTrailer);
        }
        else {
            error = new connect_error_js_1.ConnectError(`invalid grpc-status: ${grpcStatus}`, code_js_1.Code.Internal, headerOrTrailer);
        }
        error.isWireError = true;
        return error;
    }
