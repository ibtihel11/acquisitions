...
function requestHeader(useBinaryFormat, timeoutMs, userProvidedHeaders, setUserAgent) {
    ...
    const userAgent = (_b = (_a = result.get(headers_js_1.headerUserAgent)) !== null && _a !== void 0 ? _a : result.get(headers_js_1.headerXUserAgent)) !== null && _b !== void 0 ? _b : "connect-es/2.2.0";
