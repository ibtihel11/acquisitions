import { ClientIpDetails, ClientIpDetails as ClientIpDetails$1, ClientIpProvenance, ProxyService, ProxyService as ProxyService$1, cloudflare } from "@arcjet/ip";
 ...
 *   Client.
 */
export declare function createRemoteClient(options?: RemoteClientOptions): ReturnType<typeof createClient>;
 ...
 */
export type ArcjetOptions<Rules extends [...Array<Primitive | Product>], Characteristics extends readonly string[]> = Simplify<ArcjetOptions$1<Rules, Characteristics> & {
  /**
...
export interface ArcjetNode<Props extends PlainObject> {
   ...
   */
  clientIpDetails(request: ArcjetNodeRequest, options?: {
    ipSrc?: string | undefined;
  }): ClientIpDetails$1;
  /**
...
//#endregion
export { type ClientIpDetails, type ClientIpProvenance, type ProxyService, cloudflare };