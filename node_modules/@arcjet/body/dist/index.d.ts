 ...
 */
export declare function readBodyWeb(stream: ReadableStream, options?: ReadBodyOpts | null): Promise<string>;
/**
 ...
 *   Promise that resolves to a concatenated body.
 */
export declare function readBody(stream: ReadableStreamLike, options?: ReadBodyOpts | null): Promise<string>;
//#endregion